...
const MarketingPage = () => {
    return (
        <div className="flex items-center justify-center flex-col">
            ...
            >
                <div
                    className="mb-4 flex items-center justify-center shadow-sm p-4
                ...
                text-white px-4 p-2 rounded-md w-fit"
                >
                    work forward.
                </div>
            </div>
            ...
            >
                Collaborrate, manage porjects, and reach new productivity peaks.
